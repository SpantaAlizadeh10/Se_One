...
export default function GermanLevel() {
  const { t, href } = useLanguage();
  const lv = t("coursesPage.germanLevel");
      ...
      <div className="bg-white rounded-lg shadow-card p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-8 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="rounded-2xl p-5 sm:p-4 text-center bg-[#EDEAE0]">
            <h4 className="text-[16px] sm:text-[13px] font-bold mb-1 sm:mb-0.5">{lv.a1}</h4>
            <div className="text-[13px] sm:text-[11px] text-ink70 mb-4 sm:mb-3.5">A1</div>
          ...
          <div className="rounded-2xl p-5 sm:p-4 text-center bg-[#F3E0DE]">
            <h4 className="text-[16px] sm:text-[13px] font-bold mb-1 sm:mb-0.5">{lv.a2}</h4>
            <div className="text-[13px] sm:text-[11px] text-ink70 mb-4 sm:mb-3.5">A2</div>
            <div className="flex items-end justify-center gap-1.5 sm:gap-1 h-8 sm:h-6">
          ...
          <div className="rounded-2xl p-5 sm:p-4 text-center bg-[#E2E6EF]">
            <h4 className="text-[16px] sm:text-[13px] font-bold mb-1 sm:mb-0.5">{lv.b1}</h4>
            <div className="text-[13px] sm:text-[11px] text-ink70 mb-4 sm:mb-3.5">B1</div>
            <div className="flex items-end justify-center gap-1.5 sm:gap-1 h-8 sm:h-6">
