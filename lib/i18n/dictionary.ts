    ...
    coursesData: [
      {
        ...
        level: "صفر تا C1",
        desc: "دوره ۱۰ماهه برای کودکان، از یادگیری صفر تا رسیدن به سطح C1 با آموزش مرحله‌به‌مرحله.",
        lessons: 20,
        students: 100,
        price: "ماهانه ۳,۰۰۰,۰۰۰ تومان",
        duration: "۱۰ ماه",
      },
      {
        id: "free-discussion",
        ...
        level: "مکالمه آزاد",
        desc: "تقویت مکالمه انگلیسی با تمرین گفت‌وگو و تبادل نظر با سایر زبان‌آموزان.",
        lessons: 12,
        students: 90,
        price: "۸۰۰,۰۰۰ تومان",
      },
      {
        id: "english-a1-c1",
        title: "انگلیسی از A1 تا C1",
        level: "A1 تا C1",
        desc: "دوره ۱۰ماهه انگلیسی از سطح A1 تا C1 با مسیر آموزشی کامل و مرحله‌به‌مرحله.",
        lessons: 20,
        students: 100,
        price: "ماهانه ۳,۰۰۰,۰۰۰ تومان",
        duration: "۱۰ ماه",
    ...
    coursesData: [
      {
        ...
        level: "Zero to C1",
        desc: "A 10-month step-by-step English program for children, from zero to C1.",
        lessons: 20,
        students: 100,
        price: "3,000,000 Toman / month",
        duration: "10 months",
      },
      {
        id: "free-discussion",
        title: "Free Discussion Class",
        level: "Open Conversation",
        desc: "Improve your English speaking through guided conversation and discussion with other learners.",
        lessons: 12,
        students: 90,
        price: "800,000 Toman",
      },
      {
        ...
        level: "A1 to C1",
        desc: "A complete 10-month English program that takes learners from A1 to C1 step by step.",
        lessons: 20,
        students: 100,
        price: "3,000,000 Toman / month",
        duration: "10 months",
